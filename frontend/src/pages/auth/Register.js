...
const Register = () => {
    ...
    const onSubmit = async (value) => {
       dispatch(registerAction(value, function(err, data) {
           if (err) {
               if (Object.keys(err.errors).length) {
                   form.setFields(Object.entries(err.errors).reduce((acc, [key, message]) => {
                       return [
                           ...acc,
                           {
                               name: key,
            ...
            <div className="form-box">
                ...
                >
                    ...
                    <div className="form-bottom">
                        <Button type="primary" htmlType="submit" loading={promiseInProgress}>Đăng ký</Button>
                    </div>
                </Form>
            </div>
        </div>
